 ...
 *
 */
class HomeUI extends wy.BaseSprite {
	constructor() {
		super();
		this.width = 750;
		this.height = 1334;
	...
	public ele3:egret.Bitmap;
	public ele2:egret.Bitmap;
	public sgTxt:egret.TextField;
	public startBtn:egret.Bitmap;
	public ele4:egret.Bitmap;
	public ele5:egret.Bitmap;
	public ybImg:egret.Bitmap;
	public ybTxt:egret.TextField;
	public tlImg:egret.Bitmap;
	public tlTxt:egret.TextField;
	public leftBtn2:egret.Bitmap;
	public leftBtn1:egret.Bitmap;
	public leftBtn3:egret.Bitmap;
	public leftBtn4:egret.Bitmap;
	public rightBtn1:egret.Bitmap;
	public rightBtn2:egret.Bitmap;
	public rightBtn3:egret.Bitmap;
	public rightBtn4:egret.Bitmap;
	public person:egret.Bitmap;
	public pet:egret.Bitmap;
	public hintRed:egret.Bitmap;
