module wy {
	...
	export class EWMs {
		...
		public click(f: Function, thisObj: any) {
			if (this.myImg) {
		...
		public start(f: Function, thisObj: any) {
			if (this.myImg) {
		...
		public move(f: Function, thisObj: any) {
			if (this.myImg) {
		...
		public end(f: Function, thisObj: any) {
			if (this.myImg) {
		...
		public down(f: Function, thisObj: any) {
			if (this.myImg) {
		...
		public up(f: Function, thisObj: any) {
			if (this.myImg) {
