 ...
 *
 */
var MailC = (function (_super) {
    __extends(MailC, _super);
    function MailC() {
        var _this = _super.call(this) || this;
        _this.btnArr = ['backBtn', 'btn1', 'btn2'];
        return _this;
    }
    MailC.prototype.createChildren = function () {
    ...
    MailC.prototype.show = function (data) {
    ...
    /**刷新数据 */
    MailC.prototype.onMsg = function () {
        this.list.dataProvider = this.total;
        this.list.updateDisplayList();
    };
    MailC.prototype.onTouchTap = function (e) {
    ...
    MailC.prototype.touchInit = function () {
...
__reflect(MailC.prototype, "MailC");
