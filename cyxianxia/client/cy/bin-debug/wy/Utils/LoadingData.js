...
(function (wy) {
     ...
     */
    var LoadingData = (function (_super) {
        ...
        LoadingData.prototype.createOk = function (isVertical) {
            ...
            if (isVertical) {
                if (wy.LoadingData.STYLE < 3) {
                    var x = (wy.GameInterface.stage.stageWidth - 300) >> 1;
                    var y = (wy.GameInterface.stage.stageHeight - 200) >> 1;
                }
                else {
                    var x = (wy.GameInterface.stage.stageWidth - 100) >> 1;
                    var y = (wy.GameInterface.stage.stageHeight - 100) >> 1;
                }
                this.bg.graphics.drawRect(0, 0, wy.GameInterface.stage.stageWidth, wy.GameInterface.stage.stageHeight);
            }
            else {
                if (wy.LoadingData.STYLE < 3) {
                    var x = (wy.GameInterface.stage.stageHeight - 200) >> 1;
                    var y = (wy.GameInterface.stage.stageWidth - 300) >> 1;
                }
                else {
                    var x = (wy.GameInterface.stage.stageHeight - 100) >> 1;
                    var y = (wy.GameInterface.stage.stageWidth - 100) >> 1;
                }
                this.bg.graphics.drawRect(0, 0, wy.GameInterface.stage.stageHeight, wy.GameInterface.stage.stageWidth);
            }
      ...
      *@platform egret 3.0.3
      */
        LoadingData.prototype.style6 = function () {
            var loading1;
            var loading2;
            loading1 = new egret.Shape();
            loading1.graphics.beginFill(0xffffff);
    ...
    __reflect(LoadingData.prototype, "wy.LoadingData");
    /**
     *
    //  */
    // class Loading_Data {
