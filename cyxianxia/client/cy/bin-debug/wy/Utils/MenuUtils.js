...
(function (wy) {
    ...
    var MenuUtils = (function (_super) {
        ...
        function MenuUtils() {
            ...
            _this.width = wy.GameInterface.stage.stageWidth;
            _this.height = wy.GameInterface.stage.stageHeight;
            _this.createOk();
            return _this;
        }
        ...
        MenuUtils.prototype.createTopBar = function () {
            ...
            this.topShape.graphics.drawRect(0, 0, wy.GameInterface.stage.stageWidth, 60);
            ...
            this.confirmBtn.x = wy.GameInterface.stage.stageWidth - this.confirmBtn.width;
        ...
        MenuUtils.prototype.createBottomArea = function () {
            ...
            this.bottomShape.graphics.drawRect(0, 0, wy.GameInterface.stage.stageWidth, 340);
        ...
        MenuUtils.prototype.textStyle = function (tx) {
            ...
            tx.width = wy.GameInterface.stage.stageWidth;
            tx.height = 50;
            tx.size = 25;
            // tx.text = "aa";
