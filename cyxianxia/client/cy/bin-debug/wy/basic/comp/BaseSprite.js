...
(function (wy) {
    ...
    var BaseSprite = (function (_super) {
        ...
        BaseSprite.prototype.show = function (data) {
            ...
            wy.GameInterface.stage.addEventListener(egret.Event.RESIZE, this.onResize, this);
        };
        /**
         * 隐藏页面
         * 主要做移除操作：例如 监听事件
        ...
        BaseSprite.prototype.hide = function () {
            ...
            wy.GameInterface.stage.removeEventListener(egret.Event.RESIZE, this.onResize, this);
        };
        BaseSprite.prototype.onResize = function (e) {
        };
        return BaseSprite;
