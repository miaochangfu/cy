...
public class SASRsdk {
    ...
    public static String base64_hmac_sha1(String value, String keyStr) {
        ...
        try {
            ...
            encoded = new String(Base64.encode( Hash));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return encoded;
    ...
    public static String sendVoice( String data , long dataLen ) {
        ...
        try {
            ...
            Logger.info("sbResult--->"+sbResult.toString());
            AAIResStatus aAIResStatus = new Gson().fromJson( sbResult.toString(), AAIResStatus.class);
            if( aAIResStatus != null ) {
            	 return aAIResStatus.getResponse().getResult();
            }
            return null;
        } catch (Exception e) {
